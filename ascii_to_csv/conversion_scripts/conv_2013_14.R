#### Convert Cohort 16/17 ASCII file into CSV 
## V. Stevens 11/16/24
...
ascii_file <- "C16B_PUF.TXT"
# ascii_file <- "C17B_PUF.TXT"
...
write.csv(output_df, file = "C16_2013_PUF.csv", row.names = FALSE)
# write.csv(output_df, file = "C17_2014_PUF.csv", row.names = FALSE)